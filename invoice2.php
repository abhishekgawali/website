...
<!--<div class="row">
    <div class="col-sm-6" style="background-color:lavender;">Receipt Number<input type="text" id="rno" required></div>
    <div class="col-sm-6" style="background-color:lavenderblush;">Student Id <input type="date" id="d" required></div>
...
-->
	...
	<div align="center"  >
		...
		<form action="invoicep.php" method="POST">
		<tr>
			<th align="left">Receipt_No</th>
			<td align="left">
				<input type="text" id="rno" placeholder="Student Id"name="receipt"required>
			...
			<td align="left">
				<input type="text" id="sid" placeholder="Student Id"name="s_id" required>
			</td>
			</tr>
			<tr>
				<th align="left">Received with thanks from: </th>
				<td align="left">
				<input type="text" id="name" placeholder="Name of student" name="person1" required>
			</td>
			</tr>
			<tr>
				<th align="left">Rupees</th>
				<td align="left">
				<input type="text" id="amt" placeholder="Amount" name="rupees" required>
			</td>
			</tr>
			<tr>
				<th align="left">In words</th>
				<td align="left">
				<input type="text" id="amtinw" placeholder="Amount in words" name="in_words" required>
			</td>
			</tr>
			<tr>
				<th align="left">
