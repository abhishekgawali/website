...
<div class="container-fluid">
	...
	<div align="center"  >
	<form action="timesheet_insert.php" method="post">
		<table style="border-collapse:separate; border-spacing:10px 40px;">
			<tr>
				<th align="left">Date</th>
				<th align="left"><input type="date" id="d" name="time_date"></th>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="left">
				<input type="text" id="tr1" placeholder="Training 1" name="training_1"><br>
				<input type="text" id="tr2" placeholder="Training 2" name="training_2"><br>
				<input type="text" id="tr3" placeholder="Training 3" name="training_3">
			</td>
			</tr>
			<tr>
				<th align="left">Tasks</th>
				<td align="left">
				<input type="text" id="ts1" placeholder="Task 1" name="task_1"><br>
				<input type="text" id="ts2" placeholder="Task 2" name="task_2"><br>
				<input type="text" id="ts3" placeholder="Task 3" name="task_3">
			</td>
			</tr>
			<tr>
